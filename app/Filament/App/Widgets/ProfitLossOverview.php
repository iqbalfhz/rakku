...
class ProfitLossOverview extends StatsOverviewWidget
{
    ...
    protected function getStats(): array
    {
        ...
        return [
            Stat::make('Total pendapatan', $this->formatRupiah($totals['income']))
                ->color('success'),
            Stat::make('Total beban', $this->formatRupiah($totals['expense']))
                ->color('danger'),
            Stat::make($totals['net'] >= 0 ? 'Laba bersih' : 'Rugi bersih', $this->formatRupiah(abs($totals['net'])))
